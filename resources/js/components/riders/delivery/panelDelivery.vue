...
<div class="container-fluid ps-0 pe-0">
    ...
    <div v-else class="delivery-container">
        ...
        <div v-else style="width: 100%" class="d-flex flex-column">
            <hasDelivery :asosiationDelivery = "asosiationDelivery" :lang="lang" :translations="translations" :user = "user" @isChanging="onChangeDeliveries" @notifyDeliver="notifyDeliver"></hasDelivery>
        </div>
    </div>
</div>
</template>
